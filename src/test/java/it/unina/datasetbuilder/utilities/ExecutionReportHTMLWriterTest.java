...
@Ignore
public class ExecutionReportHTMLWriterTest {
    @Test
    public void testReport(){
        IExecutionReportWriter iExecutionReportWriter= new ExecutionReportHTMLWriter("src/test/resources/reportHTML.html");
        ...
        JobInformationDTO job2 = getJobInformationDTO("apache/servicecomb-pack",JobStatusEnum.CURR_NO_COMPILE);
        JobInformationDTO job3 = getJobInformationDTO("zhang-rf/mybatis-boost",JobStatusEnum.PREV_NO_COMPILE);
        jobList.add(job1);
        jobList.add(job2);
        jobList.add(job3);
